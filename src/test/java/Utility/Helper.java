...
public class Helper {
	public static WebDriver startBrowser(String browser,String url) {
		...
		if (browser.equalsIgnoreCase("Chrome") || browser.equalsIgnoreCase("GC")
			...
			System.setProperty("webdriver.chrome.driver", "./ChromeBrowserJars/chromedriver.exe");
			driver = new ChromeDriver();
			driver.manage().window().maximize();
		} else if (browser.equalsIgnoreCase("FF") || browser.equalsIgnoreCase("Firefox")
				|| browser.equalsIgnoreCase("Mozila")) {
			System.setProperty("webdriver.gecko.driver", "./FirefoxBrowserJars/geckodriver.exe");
